/**
  * adapted from https://github.com/Svish/iso-3166-country-codes/blob/master/countries.sql
  *
  * note:
  * - remove double quotes on table names + column names
  * - replace double quotes on strings
  * - remove single quotes inside names
  *
...
CREATE TABLE countries (
  ...
  country_nr VARCHAR2(3) NOT NULL ,
...
INSERT INTO countries (code, continent_code, name, iso3, country_nr, full_name) VALUES
  ...
  ('DZ', 'AF', 'Algeria', 'DZA', '012', 'Peoples Democratic Republic of Algeria'),
  ...
  ('BD', 'AS', 'Bangladesh', 'BGD', '050', 'Peoples Republic of Bangladesh'),
  ...
  ('CN', 'AS', 'China', 'CHN', '156', 'Peoples Republic of China'),
  ...
  ('CI', 'AF', 'Cote dIvoire', 'CIV', '384', 'Republic of Cote dIvoire'),
  ...
  ('KP', 'AS', 'Korea', 'PRK', '408', 'Democratic Peoples Republic of Korea'),
  ('KR', 'AS', 'Korea', 'KOR', '410', 'Republic of Korea'),
  ('KW', 'AS', 'Kuwait', 'KWT', '414', 'State of Kuwait'),
  ('KG', 'AS', 'Kyrgyz Republic', 'KGZ', '417', 'Kyrgyz Republic'),
  ('LA', 'AS', 'Lao Peoples Democratic Republic', 'LAO', '418', 'Lao Peoples Democratic Republic'),
  ...
  ('SJ', 'EU', 'Svalbard and Jan Mayen Islands', 'SJM', '744', 'Svalbard and Jan Mayen Islands'),
  ...
  ('GB', 'EU', 'United Kingdom of Great Britain and Northern Ireland', 'GBR', '826', 'United Kingdom of Great Britain and Northern Ireland'),
