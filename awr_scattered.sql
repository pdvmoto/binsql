...
col avg_wait_scat format 999.999 head "Average Wait (ms)|db file scattered read"
select s.begin_interval_time, s.end_interval_time, s.end_interval_time - s.begin_interval_time diff ,b.snap_id||','||e.snap_id snapshots,
              ...
              round ( (e.TIME_WAITED_MICRO - b.TIME_WAITED_MICRO) / (decode(e.TOTAL_WAITS - b.TOTAL_WAITS,0,1,e.TOTAL_WAITS - b.TOTAL_WAITS)),4) / 1000 avg_wait_scat
